...
The orange star marks the threshold value of 0.35, where the model achieves its highest F1 score. The dotted horizontal line indicates the baseline precision of a model that always predicts "forest" for every pixel in the validation set. The recall for such a baseline equals 1.
:::
