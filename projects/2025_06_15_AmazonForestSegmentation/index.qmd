...
Here is a [Google drive folder](https://drive.google.com/drive/folders/1FXKWImrCqdXtTWFVrqiZx0NLHim4K08d?usp=sharing) where one can access all plots for images in the validation and test datasets.
:::
