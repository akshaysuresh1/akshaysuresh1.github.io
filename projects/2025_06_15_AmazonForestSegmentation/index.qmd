...
Here is a [Google drive folder](https://drive.google.com/drive/folders/1FXKWImrCqdXtTWFVrqiZx0NLHim4K08d?usp=sharing) from where one can access plots for all images in the validation and test datasets.
:::
