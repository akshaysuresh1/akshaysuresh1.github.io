...
categories: [AI for Climate, Time Series Forecasting]
---
---
...
**Pressure catalog:** epoch, fluid pore pressure at seismicity centroid, pressurization rate at seismicity centroid
...
$$
\frac{{\rm 30,000 } \times {\rm 1 \ day} }{\rm 5 \ days } = {\rm 6,000 \ analysts \ from \ a \ pool \ of \ 10,000 \ seismology \ PhDs}
$$
...
1. In the above calculations, we assumed a gap of 5 days between successive model runs.
