...
categories: [Time Series Forecasting, Physics-informed AI, Supervised Learning, AI for Climate]
---
---
...
- **Lead mentors:** [Kayla Kroll](https://people.llnl.gov/kroll5), [Christopher Sherman](https://www.linkedin.com/in/christopher-sherman-6617b776) & [Constantin Weisser](https://www.linkedin.com/in/constantin-weisser)
...
A spatiotemporal grid of subsurface fluid pore pressures and pressurization rates constructed from a map of injection wells and time series of fluid injection volume rates at each well.
...
| Location (USA) | Spatial earthquake footprint | No. of injection wells | Assumed no. of causally connected earthquake clusters | Cause of induced earthquakes |
|---------|:-----|------:|:------:|:------:|
| Decatur, Illinois | 4 km $\times$ 5 km | 1 | 1 | Subsurface $CO_2$ injection |
...
$$
This would require restructuring the academic seismological community to do repetitive meaningful tasks and stop working on other pressing issues. Also, achieving safety with forecasts would be expensive
...
2. Though our streamlined CRS implementation comes with a training time of only 3 minutes, we assumed a generous modeling time of about 2&nbsp;hours to account for any hardware maintenance that may be needed during runs.
